"""
FedDyn with Squared Hinge Loss
...
def main_feddyn_sq_hinge(global_model, client_schedule, train_data_list, test_data, lr=None):
    ...
    for round_idx in range(CR):
        ...
        # Logging
        print(f"[FedDyn-SqHinge] Round {round_idx + 1}/{CR} | Accuracy: {acc:.4f}")
...
Our Implementation:
    grad_task = ∇L_sqhinge(θ) + λ*w         # Squared hinge loss gradient + L2 reg
